            ...
            URLSession.shared.dataTask(with: url) { data, response, error in
                ...
                do {
                    ...
                    DispatchQueue.main.async {
                        completion(title, metaDescription, extractedLinks, extractedImages)
                    }
                } catch {
                    completion(nil, nil, [], [])
                }
